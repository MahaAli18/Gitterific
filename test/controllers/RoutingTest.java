...
public class RoutingTest extends WithApplication {
	...
	public void testListRepositories() throws Exception {
		...
		ListRepositories ListRep = new ListRepositories("UltimateGamer", "UltimateGamer",
				"https://api.github.com/users/89z", "https://api.github.com/repos/89z/mech/issues", "public",
				"https://api.github.com/repos/89z/mech/commits", "https://api.github.com/repos/89z/mech/pulls",
	...
	public void Test_UsersList1() {
		...
		ArrayList<String> lst = new ArrayList<>();
		lst.add("Random");
		UsersList user = new UsersList("Fighter", "Fighter", "reponame", "git", "28", "11", "bot", "bot", "api",
				"www.github.com/image");
...
//Routing Tests    
	...
	public void testTopicsView() {
		Http.RequestBuilder request = new Http.RequestBuilder().method(GET).uri("/topics?query=google");
	...
	/*
	 * @Test public void testissues() { Http.RequestBuilder request = new
	 * Http.RequestBuilder() .method(GET) .uri("/fetchIssues");
	 * 
	 * Result result = route(app, request); System.out.println(
	 * "======================================================================"+
	 * result.as(CONTENT_LANGUAGE)); assertEquals(OK, result.status()); }
	 */

	@Test
	public void testfetchResults() {
		Http.RequestBuilder request = new Http.RequestBuilder().method(GET).uri("/fetch?query=google");
	...
	public void testUsers() {
		Http.RequestBuilder request = new Http.RequestBuilder().method(GET).uri("/users/WaleedAhmed05");
	...
	public void testUserRepos() {
		Http.RequestBuilder request = new Http.RequestBuilder().method(GET).uri("/users/waleedAhmed05/repos");
